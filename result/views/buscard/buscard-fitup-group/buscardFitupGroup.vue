...
<script>
import buscardFitupGroupConfig from "./buscardFitupGroupConfig.js";

export default {
    mixins: [buscardFitupGroupConfig],
    components: {
...
@import "./buscardFitupGroupConfig.scss";
</style>