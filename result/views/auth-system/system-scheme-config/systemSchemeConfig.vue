...
<script>
import systemSchemeConfigConfig from "./systemSchemeConfigConfig.js";

export default {
    mixins: [systemSchemeConfigConfig],
    components: {
...
@import "./systemSchemeConfigConfig.scss";
</style>